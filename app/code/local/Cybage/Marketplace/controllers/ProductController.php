...

{
        ...
        if ($_FILES) {
            ...
            foreach ($_FILES as $key => $value) {
                ...
                if ($value['size'] > $fileSize) {
                    ...
                    $this->_getSession()->addError(Mage::helper('marketplace')->__('Unable to process your request due to large image size 2, please try again.'));
...

    {
        ...
        {   
            ...
            $this->_getSession()->addError($this->__('Unable to process request for below files due to large image size 3, please try again. <br> '.implode("<br>", $larger)));
